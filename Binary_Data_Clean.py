...
class Binary_Data_Clean:
    ...
    #Makes the cuts for number of visits I want. This should be the last thing to
    #run because if you make any cuts after if then you'll run into velocity problems.
    def nvisits_cut(self,ALL_AVERAGE,ALL_VISIT, n_cut):
        ...
        ALL_AVERAGE_SIMPLIFIED = ALL_AVERAGE_SIMPLIFIED[:][ALL_AVERAGE_SIMPLIFIED['NVISITS'][:] >= n_cut]
    ...
    #This also needs to be done before I make the cut between LMC and SMC
